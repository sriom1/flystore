...
<?php
  if(isset($_POST["updateproduct"])){
    ...
    $product_image = mysqli_real_escape_string($conn, $_POST['p_image']);
         ...
         $query="Update product set  p_category='$product_category',p_name='$product_name', p_price='$product_price', p_image='$product_image' where p_id='$p_id'";
...
<head>
    ...
    <title>Update Product - FLYSTORE</title>
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card border-0 shadow rounded-3 cntbox">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        echo "<h3 class='display-6 fw-normal 
                        mb-5'>Update product $p_id</h3>";
                        ?>
                        <form method='post'>
